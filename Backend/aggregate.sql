...
from
Event_415 as E join Volunteers_415 as V on E.Event_ID = V.Event_ID group by(V.Event_ID);


--event per manager
select M.Manager_Name as Manager_Name,count(M.Event_ID) as Events from Manager_415 as M group by (Manager_ID);
